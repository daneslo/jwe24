...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 23. Mrz 2024 um 16:05
...
CREATE TABLE `passagiere` (
  ...
  `Geburtsdatums` date NOT NULL,
  `Flungangst` tinyint(1) DEFAULT NULL,
...
--
ALTER TABLE `passagiere`
  ADD CONSTRAINT `passagiere` FOREIGN KEY (`fluege_id`) REFERENCES `fluege` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
