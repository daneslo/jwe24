...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 09. Mrz 2024 um 15:17
...
CREATE TABLE IF NOT EXISTS `benutzer` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `benutzername_3` (`benutzername`),
...
(1, 'herbert', NULL, '1234'),
(3, 'daniela', 'daniela@wifi.at', 'code1'),
(4, 'gustav', 'gustav@wifi.at', '3082');
...
CREATE TABLE IF NOT EXISTS `zutaten` (
  ...
  `einhalt` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
